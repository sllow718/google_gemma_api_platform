    ...
    <div className="flex min-h-full flex-col items-center justify-center bg-gray-50 px-4 py-16">
      <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="mb-8 text-center">
          <span className="inline-block rounded bg-blue-600 px-2 py-1 text-sm font-bold text-white">G</span>
          <h1 className="mt-4 text-2xl font-bold text-gray-900">Gemma API Platform</h1>
          <p className="mt-2 text-sm text-gray-500">Sign in to manage your API configurations</p>
        </div>
